...
import acme.features.entities.aircraft.AircraftRepository;
...
public class AircraftValidator extends AbstractValidator<ValidAircraft, Aircraft> {
	...
	public boolean isValid(final Aircraft aircraft, final ConstraintValidatorContext context) {
		...
		if (aircraft == null)
			...
			existingAircraft = this.repository.findAirportByRegistrationNumber(aircraft.getRegistrationNumber());
