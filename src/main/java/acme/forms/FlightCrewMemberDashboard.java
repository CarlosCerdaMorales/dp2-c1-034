...
public class FlightCrewMemberDashboard extends AbstractForm {
	...
	// TThe number of legs that have an activity log record with an incident
	// severity ranging from 0 up to 3, 4 up to 7, and 8 up to 10.
	...
	Map<String, Integer> numberOfFlightAssignmentsGroupedByTheirStatus;

	// The average, minimum, maximum, and standard deviation of the number of flight
	// assignments they had in the last month..
