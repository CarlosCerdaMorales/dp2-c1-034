...
public interface FlightCrewMemberFlightAssignmentRepository extends AbstractRepository {
	...
	@Query("select l from FlightAssignment l where l.leg.id = :id and l.flightCrewDuty = acme.entities.flightassignment.FlightCrewDuty.PILOT and l.draftMode = false")
	List<FlightAssignment> findFlightAssignmentByLegAndPilotDuty(int id);

	@Query("select l from FlightAssignment l where l.leg.id = :id and l.flightCrewDuty = acme.entities.flightassignment.FlightCrewDuty.CO_PILOT and l.draftMode = false")
